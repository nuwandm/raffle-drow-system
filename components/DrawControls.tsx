...
export default function DrawControls({ state, onDraw, onReset }: DrawControlsProps) {
  ...
  return (
    <div className="flex justify-center mb-4">
      ...
      >
        <span className="font-horror" style={{ fontFamily: "'Pirata One', cursive", letterSpacing: '0.25em', WebkitTextStroke: '0.5px rgba(0,0,0,0.6)', textShadow: '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000' }}>
